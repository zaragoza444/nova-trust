# Z Blockchain Besu Infrastructure

Production-oriented Besu layout for **Z Blockchain** (chain ID `44002`), aligned with NRW World (`33001`) and Nova One (`22016`).
...
- `config/genesis.json`: Z Blockchain genesis (chain ID 44002)
...
Bootstrap contracts on Z Blockchain:
