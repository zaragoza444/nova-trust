...
import { shellSignals } from "../lib/mock-data";
import { formatChainIdentifier, primaryChain, zChainProfiles, type ChainProfile } from "../lib/z-chains";
        ...
        <header className="topBar">
          <div className="heroIntro">
            <div className="heroStatusRow">
              ...
              <div className="secondaryPill">Z Ecosystem</div>
            </div>
            <h1>{title}</h1>
            <p>{description}</p>
          </div>
          <div className="topBarActions">
            <button className="secondaryButton">Production</button>
            <button className="primaryButton">Z Wallet</button>
          </div>
        </header>
