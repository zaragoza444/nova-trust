...
export default async function MultiNetworkPage() {
  ...
  return (
    <PageShell
      ...
      description="TRON basement network anchoring public Ethereum and BNB Smart Chain rails, with bridge lanes into Z Chain permissioned settlement."
    ...
    >
      ...
      <section className="heroGrid">
        <article className="card heroCard heroCardPrimary">
          ...
          <h2>TRON is the basement network for Z ecosystem multi-network operations.</h2>
          <p>
        ...
        <article className="card">
          <div className="sectionHeader">
            <div>
              ...
              <h3>Basement to Z Chain settlement</h3>
            </div>
          </div>
          <div className="queueList">
