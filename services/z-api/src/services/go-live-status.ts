...
export async function getGoLiveStatus() {
  ...
  return {
    ...
    endpoints: {
      ...
      zEcosystem: "/api/z-ecosystem/overview",
      zChart: "/api/zchart/markets",
      zTrade: "/api/ztrade/markets",
      zSwap: "/api/zswap/pools",
      ...
      dashboard: process.env.Z_DASHBOARD_URL ?? "http://127.0.0.1:3100",
